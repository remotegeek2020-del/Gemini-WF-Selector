...
const SYSTEM_PROMPT = `You are an expert sales persona strategist. Given a description of a target customer segment, generate a detailed sales persona.

Respond with valid JSON only — no markdown, no code fences, just raw JSON matching this shape:
{
  "name": "Short memorable persona name (2-4 words, e.g. 'Enterprise Decision Maker')",
