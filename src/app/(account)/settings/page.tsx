...
const SERVICE_CONFIGS: ServiceConfig[] = [
  {
    service: 'apollo',
    label: 'Apollo.io',
    description: 'Primary enrichment — always runs first. Provides title, company, LinkedIn, industry, and employment history.',
  ...
  },
  {
    ...
    description: 'Fallback profile enrichment when Apollo finds no title or company. Large dataset, good coverage for small business owners and independent agents.',
  ...
  },
  {
    ...
    label: 'BetterContact',
    description: 'Phone number recovery — aggregates 15+ sources. Runs only when no phone number is found from previous tools.',
    placeholder: 'your-bettercontact-api-key',
  },
  {
    service: 'kaspr',
    label: 'Kaspr',
    description: 'LinkedIn-sourced mobile phone numbers. Runs when phone is still missing and a LinkedIn URL is available.',
    placeholder: 'your-kaspr-api-key',
  },
  {
    service: 'cognism',
    label: 'Cognism',
    description: 'B2B mobile numbers and email finder. Runs as a last resort for phone recovery.',
  ...
  },
  {
    service: 'findymail',
    label: 'Findymail',
    description: 'Email finder via LinkedIn URL or name + domain. Runs as a final fallback for work email recovery.',
    placeholder: 'your-findymail-api-key',
  },
  {
    service: 'enrow',
    label: 'Enrow',
    description: 'Email verification — confirms all collected emails are valid and deliverable. Very cheap (~$0.001/email).',
    placeholder: 'your-enrow-api-key',
  },
  {
    service: 'highlevel',
    label: 'Highlevel (GHL)',
    description: 'Used to trigger workflows, update contact profiles, and write persona data to custom fields.',
